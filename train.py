...
def parse_args():
    ...
    parser.add_argument('--seq_length', type=int, default=2, help='Sequence length 2-8')
    parser.add_argument('--num_pred', type=int, default=4, help='Number of predictions 0-6')
...
def main():
    ...
    if args.resume:
        ...
        save_directory = os.path.join(current_dir, base_save_dir, f'image_L{args.seq_length}_J{args.num_pred}_{dayTime}_{hourTime}{mode_suffix}')
